...
CodeQL was updated to v4.38.0 on 2026-09-21 after checking its upstream tag
and [official release notes](https://github.com/github/codeql-action/releases/tag/v4.38.0).
